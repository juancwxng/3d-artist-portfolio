  ...
  return (
    <Link
      ...
      className={cn(
        ...
        featured &&
          "col-span-full grid grid-cols-[1.35fr_1fr] max-md:grid-cols-1",
      )}
      data-cursor="view"
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-center mt-4 pt-[0.875rem] border-t border-[#f0ece6]">
          ...
          <span
            className="text-[#7a6e63] transition-[transform,color] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-[#2b2a27] inline-flex items-center justify-center"
            aria-hidden="true"
          >
            <Image
